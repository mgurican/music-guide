# 🎵 Song & Style Tone Presets

Return to [[Home]]

---

## 📊 Master Song Tone Table

| Song / Style | Guitar Selection | Amp & Voicing | Drive & Boost Pedals | Cabinet IR Choice |
| :--- | :--- | :--- | :--- | :--- |
...
## 🎸 Detailed Song Dial-In Notes

### 1. Jack White - *"You'll Never Fix Me"* & *"Thick as Thieves"*
* **Goal:** Garage-rock raw fuzz & unpolished swagger vs modern tight high gain.
* **Pickup Strategy:** Split pickups lowered output kicked with [[Hardware & Routing#TC Electronic Spark Mini|TC Spark Mini]].
* **EQ:** Use [[Hardware & Routing#Boss EQ-200|Boss EQ-200]] to push mid-frequencies while controlling high-end hash.

### 2. Dream Theater - Clean Arpeggios (*"Pull Me Under"*)
* **Guitar:** [[Guitars & Pickups#Music Man Majesty|Music Man Majesty]] (Center selector = dual inner coils in parallel).
* **Compression:** [[Hardware & Routing#TC Electronic HyperGravity|TC HyperGravity Compressor]] running MD3 algorithm for studio rack compression sustain without tone coloration.
